//Alan Pérsico Lihue Milano Com 3 
//link al video explicativo: https://youtu.be/QqmjvKGflBs
...
if (!sonidoReproducido) {
     ...
     text ('Persico Alan, Milano Lihue, Com 3', width / 2, 300) ;
     botonstart.hide();
     botontutorial.hide();
     botonvolver.show();
   }  else if (estado==4){
